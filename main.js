      ...
      666: (t) => {
        var e = (function (t) {
              ...
              (i._invoke = (function (t, e, n) {
                ...
                return function (o, i) {
                  ...
                  for (n.method = o, n.arg = i; ; ) {
                    ...
                    var u = l(t, e, n);
                    if ('normal' === u.type) {
                      if (((r = n.done ? v : h), u.arg === p)) continue;
          ...
          var E = Object.getPrototypeOf,
            w = E && E(E(O([])));
          w && w !== n && r.call(w, i) && (L = w);
          var x = (g.prototype = m.prototype = Object.create(L));
          function b(t) {
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      (o = document.querySelectorAll('[data-tab="menu"] li')),
        ...
        o.length &&
          i.length &&
          (i[0].classList.add('ativo', i[0].dataset.anime),
        ...
        (function () {
          ...
          document.querySelectorAll('[data-menu="smooth"] a[href^="#"]').forEach(function (e) {
        ...
        (function () {
          var t = document.querySelector('[data-modal="open"]'),
        ...
        (function () {
          ...
          function r() {
            var t = (function (t) {
              ...
              return e.classList.add('tooltip'), (e.innerText = n), document.body.appendChild(e), e;
            })(this);
            (e.tooltipBox = t),
        ...
        (c = (a = document.querySelector('[data-semana]')).dataset.semana.split(',').map(Number)),
        (u = a.dataset.horario.split(',').map(Number)),
        (l = (s = new Date()).getDay()),
        (f = s.getHours()),
        (h = c.includes(l)),
        (d = f >= u[0] && f < u[1]),
        h && d && a.classList.add('aberto'),
        (function () {
          function t() {
            return (t = r(
              p().mark(function t(e) {
