...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFuncionamento)\n/* harmony export */ });\nfunction initFuncionamento() {\n  var funcionamento = document.querySelector('[data-semana]');\n  var diasSemana = funcionamento.dataset.semana.split(',').map(Number); // Transformar em Number\n\n  var horarioSemana = funcionamento.dataset.horario.split(',').map(Number); // Transformar em Number\n\n  var dataAtual = new Date();\n  var diaAtual = dataAtual.getDay();\n  var horarioAtual = dataAtual.getHours();\n  var isDayOpen = diasSemana.includes(diaAtual);\n  var isHourOpen = horarioAtual >= horarioSemana[0] && horarioAtual < horarioSemana[1];\n  if (isDayOpen && isHourOpen) funcionamento.classList.add('aberto');\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/funcionamento.js?");
